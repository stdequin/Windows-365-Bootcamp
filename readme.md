...
2. Make a note of the admin and end user credentials in a notepad for easy access.
3. Open an "InPrivate" browser and navigate to (htps://intune.microsoft.com) and sign in the with Admin account.
